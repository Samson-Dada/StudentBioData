    ...
    public partial class SeedData : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 6, 3, 8, 44, 13, 288, DateTimeKind.Utc).AddTicks(6524), "John", "Male", "Deo", "Senior secondar school", "Math" },
                    { 2, new DateTime(2023, 6, 3, 8, 44, 13, 288, DateTimeKind.Utc).AddTicks(6530), "Carlos", "Female", "Temi", "Senior secondar school", "Math" },
                    { 3, new DateTime(2023, 6, 3, 8, 44, 13, 288, DateTimeKind.Utc).AddTicks(6532), "Dayo", "Male", "Benson", "Senior secondar school", "Math" }
                });
